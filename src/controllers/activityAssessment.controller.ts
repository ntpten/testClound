...
import { ActivityAssessmentService } from "../services/activityAssessment.service";
...
export class ActivityAssessmentController {
  ...
  getActivityAssessment = async (req: Request, res: Response) => {
    try {
      const activityAssessments = await this.activityAssessmentService.getActivityAssessment();
