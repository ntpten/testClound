...
export class ActivityAssessment {
  ...
  @ManyToOne(() => Activity, (activity) => activity.ac_id, { onUpdate: 'CASCADE', onDelete: 'CASCADE' })
  @JoinColumn({ name: 'ac_id' })
  activity?: Activity;

  @ManyToOne(() => Assessment, (assessment) => assessment.as_id, { onUpdate: 'NO ACTION', onDelete: 'NO ACTION' })
